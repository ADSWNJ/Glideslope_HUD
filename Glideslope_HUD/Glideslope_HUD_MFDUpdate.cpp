// ==============================================================
//
//	Glideslope_HUD (MFD Display Update)
//	==================================
//
...
bool Glideslope_HUD::Update(oapi::Sketchpad *skp)
{
  LC->skp = skp;
  ...
  skpFormatText(2, l++, "Tst");
  skpFormatText(2, l, "A %5.2f", VC->rot_test.x);
  skpFormatText(4, l++, "%5.2f", VC->rot_test.x * DEG);
  skpFormatText(2, l, "B %5.2f", VC->rot_test.y);
  skpFormatText(4, l++, "%5.2f", VC->rot_test.y * DEG);
  skpFormatText(2, l, "G %5.2f", VC->rot_test.z);
  skpFormatText(4, l++, "%5.2f", VC->rot_test.z * DEG);
