// ==============================================================
//
//	Glideslope_HUD (Vessel Core Header)
//	=============================
//
...
class Glideslope_HUD_VCore {
  public:
    ...
    void setPos(double lon, double lat, double alt, double vel, double azimuth);
...
#define MAX_HIST 127
    ...
    int logState{ 0 };                           // If logging, create DUMP.CSV in the Glideslope_HUD folder
